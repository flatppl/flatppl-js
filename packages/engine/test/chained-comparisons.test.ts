...
function parseRHS(src: any, opts: any) {
  ...
  // These snippets reference bare identifiers just to keep them short —
  // filter the resulting "Undefined variable" diagnostics regardless of
  // severity, since these tests check parsing, not name resolution.

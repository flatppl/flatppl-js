...
const EXPECTED_MANIFEST_SHA256 = '8219bb442f693ad06a1a153977a9d86f188505e675ce0dcb39c7b94b53405d7e';
...
export async function verifyThemeBundle(bundle = defaultBundle) {
  ...
  if (await digest(manifestPath) !== EXPECTED_MANIFEST_SHA256) {
    errors.push('manifest.json: does not match pinned flatppl-theme v0.1.7');
    return errors;
  }

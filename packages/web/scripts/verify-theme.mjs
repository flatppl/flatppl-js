...
const EXPECTED_MANIFEST_SHA256 = '7bac1959dbe0cbc61ad45184e3dfff52423bc3ae5989871dbaf1f40390c14edc';
...
export async function verifyThemeBundle(bundle = defaultBundle) {
  ...
  if (await digest(manifestPath) !== EXPECTED_MANIFEST_SHA256) {
    errors.push('manifest.json: does not match pinned flatppl-theme v0.1.3');
    return errors;
  }
